  ...
  #define K_P_OA1 1.1                        // For positive error (cases where the robot moves further from the object or at corners)
  #define K_P_OA2 4.4                         // For negative error (cases where the robot moves closer to the object)
  #define K_D_OA 0.5
  ...
  #define MOVE_SPEED_OA 150                    // This is the baseline velocity of the motors, onto which a mot_diff_speed will be added/subtracted during object avoidance

  #define DISTANCE_OA 15                      // The distance that will trigger object avoidance mode
  #define DISTANCE_SP 15                     // The setpoint (desired) distance between the robot and the obstacle during object avoidance mode
  ...
  void loop() {
      ...
      switch(current_state) {
          ...
          case object_avoiding_2: 
              ...
              if (distance_error < 0) {
                mot_diff_speed = K_P_OA1 * distance_error + K_D_OA * distance_delta; 
              }
              else {
                mot_diff_speed = K_P_OA2 * distance_error + K_D_OA * distance_delta; 
              }
              ...
              // Serial.print(K_P_OA * distance_error);Serial.print(" | ");
              // Serial.print(K_D_OA * distance_delta);Serial.print(" | ");
              break;
